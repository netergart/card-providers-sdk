import { ICurrencyExchange, IFeeConfig, ISignedRate } from "../../currency/interfaces/currency.interface";
import { IWalletSignedRate, IWalletSignedRateResponse } from "../../wallet/interfaces/wallet.interface";
...
export type IPaymentWithdrawRequest = ATMWithdrawRequest | BankTransferWithdrawRequest | CryptoWithdrawRequest | PaySpotWithdrawRequest | CounterpartyWithdrawRequest;
