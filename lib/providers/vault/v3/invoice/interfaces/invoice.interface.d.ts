import { IPayment, IPaginatedResponse, IPaginationParams } from "../../interfaces/common.interface";
...
export type ICreateInvoiceRequest = ICheckoutInvoiceRequest | IPExternalInvoiceRequest | IPlatformInvoiceRequest;
...
export interface IInvoiceListResponse extends IPaginatedResponse<IInvoiceList> {
}
