import { CardStatus, CardType, IAddress, IPaginatedResponse, IPaginationParams } from "../../interfaces/common.interface";
...
export interface ICardTxHistoryResponse extends IPaginatedResponse<ICardTxHistoryResponseData> {
}
