...
export interface IReceipt extends IReceiptOriginatorInfo, IReceiptCounterpartyInfo, IReceiptExchangeInfo, IReceiptTransferInfo {
    note: string;
    rail: string;
...
export interface IWalletGetBalanceLogListRequest extends Omit<IPaginationParams, "sort"> {
    accountIds?: string[];
    currency?: string;
    from?: string;
    to?: string;
