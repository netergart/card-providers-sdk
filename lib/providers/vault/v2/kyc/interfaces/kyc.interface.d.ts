...
export interface IKycInfoByIdRequest extends IKycStatusRequest, IKycByIdRequest {
}
...
export interface IKycInfoDocumentRequest extends IKycByIdRequest, IKycDocumentByIdRequest {
}
